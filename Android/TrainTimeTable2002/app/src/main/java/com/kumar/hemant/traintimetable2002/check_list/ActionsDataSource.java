...
//        int year1=c1.get(Calendar.YEAR);
  //      int month1=c1.get(Calendar.MONTH);
		...
		Log.v("WWWWWWWWA..."," WW"+date1.subSequence(0,4));
		Log.v("WWWWWWWWB..."," WW"+date1.subSequence(5,7));
		Log.v("WWWWWWWWB..."," WW"+date1.subSequence(8,10));
        int year1 = (Integer.parseInt(""+date1.subSequence(4,8)));
		int month1 = (Integer.parseInt(""+date1.subSequence(8,10)));
		int day1 = (Integer.parseInt(""+date1.subSequence(10,12)));
		return(year1*10000+month1*100+day1);
	}
...
//			Calendar c1=Calendar.getInstance();
			...
			if(c1.get(Calendar.DAY_OF_WEEK)== Calendar.SATURDAY)
				weekDay="Sat";
			//return(""+weekDay+", "+ day1);
			Log.v("WWWWWWWW2..."," WW..."+""+year1+" "+month1+" "+day2+", "+weekDay);
			return(""+weekDay + "-" + year1+""+month2+""+day2);
		}

	public String getStringDateParam()
	{
//			Calendar c1=Calendar.getInstance();
		Calendar c1=TtDSQLiteHelper.cal1;
		int year1=c1.get(Calendar.YEAR);
		...
		if(c1.get(Calendar.DAY_OF_WEEK)== Calendar.SATURDAY)
			weekDay="Sat";
		//return(""+weekDay+", "+ day1);
		Log.v("WWWWWWWW1..."," WW..."+""+year1+" "+month1+" "+day2+", "+weekDay);
