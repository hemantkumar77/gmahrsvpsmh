package com.kumar.hemant.traintimetable2002.RTO
...
//import com.kumar.hemant.traintimetable
...
import com.kumar.hemant.traintimetable2002.check_list.check_list

/*import com.kumar.hemant.traintimetable.Action
import com.kumar.hemant.traintimetable.R
import com.kumar.hemant.traintimetable.ActionsDataSource
import com.kumar.hemant.traintimetable.DatePickerFragment
...
import com.kumar.hemant.travelguide.Train.Train;
import com.kumar.hemant.travelguide.Train.TrainActivity;
import com.kumar.hemant.travelguide.Train.TrainsAdapter;*/
...
class RTO : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
...
*/
    ...
    private fun startSpeechToText(){
        ...
        speechRecognizer.setRecognitionListener(object : RecognitionListener{
            override fun onReadyForSpeech(bundle: Bundle) {textSummary.setText("Ready...")}
            override fun onBeginningOfSpeech() {textSummary.setText("Begin...")}
            override fun onRmsChanged(v: Float) {textSummary.setText("changed..." + v)}
            override fun onBufferReceived(buffer: ByteArray) {textSummary.setText("Received...")}
            override fun onEndOfSpeech() {textSummary.setText("End...")}
            override fun onError(error: Int) {textSummary.setText("Error..." + error)}
            ...
            override fun onPartialResults(partialResults: Bundle) {textSummary.setText("Partial Results...")}
            override fun onEvent(i: Int, bundle: Bundle) {textSummary.setText("Event..." + i)}
        })
