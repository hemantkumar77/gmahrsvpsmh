package com.kumar.hemant.melisarala.RTO;
...
import com.kumar.hemant.melisarala.Train.TrainActivity;
import com.kumar.hemant.melisarala.Checklist.checktask;
import com.kumar.hemant.melisarala.Train.AddStation;
...
import java.io.File;
import com.kumar.hemant.melisarala.Train.MVCView;

public class RTOActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String xmlFilePath=Environment.getExternalStorageDirectory().getAbsolutePath();
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        try{
            File f = new File(xmlFilePath + File.separator + fileName);
...
//        strUP[62T] = "Jaunpur for taxis, private vehicle";
        ...
        etRTOState.addTextChangedListener(new TextWatcher() {

            public void onTextChanged(CharSequence s, int start, int before,
                                      int count) {
                Integer textlength1 = etRTOState.getText().length();
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.detail:
                ...
                String tempString="";
                if(strState.toUpperCase().contains("AN")){tempString=(strAN[intRTOCode]+ ", "+ strAN[0]);}
                else if(strState.toUpperCase().contains("AP")){tempString=(strAP[intRTOCode]+ ", "+ strAP[0]);}
                else if(strState.toUpperCase().contains("AR")){tempString=(strAR[intRTOCode]+ ", "+ strAR[0]);}
                else if(strState.toUpperCase().contains("AS")){tempString=(strAS[intRTOCode]+ ", "+ strAS[0]);}
                else if(strState.toUpperCase().contains("BR")){tempString=(strBR[intRTOCode]+ ", "+ strBR[0]);}
                else if(strState.toUpperCase().contains("CG")){tempString=(strCG[intRTOCode]+ ", "+ strCG[0]);}
                else if(strState.toUpperCase().contains("CH")){tempString=(strCH[intRTOCode]+ ", "+ strCH[0]);}
                else if(strState.toUpperCase().contains("DD")){tempString=(strDD[intRTOCode]+ ", "+ strDD[0]);}
                else if(strState.toUpperCase().contains("DL")){tempString=(strDL[intRTOCode]+ ", "+ strDL[0]);}
                else if(strState.toUpperCase().contains("DN")){tempString=(strDN[intRTOCode]+ ", "+ strDN[0]);}
                else if(strState.toUpperCase().contains("GA")){tempString=(strGA[intRTOCode]+ ", "+ strGA[0]);}
                else if(strState.toUpperCase().contains("GJ")){tempString=(strGJ[intRTOCode]+ ", "+ strGJ[0]);}
                else if(strState.toUpperCase().contains("HP")){tempString=(strHP[intRTOCode]+ ", "+ strHP[0]);}
                else if(strState.toUpperCase().contains("HR")){tempString=(strHR[intRTOCode]+ ", "+ strHR[0]);}
                else if(strState.toUpperCase().contains("JH")){tempString=(strJH[intRTOCode]+ ", "+ strJH[0]);}
                else if(strState.toUpperCase().contains("JK")){tempString=(strJK[intRTOCode]+ ", "+ strJK[0]);}
                else if(strState.toUpperCase().contains("KA")){tempString=(strKA[intRTOCode]+ ", "+ strKA[0]);}
                else if(strState.toUpperCase().contains("KL")){tempString=(strKL[intRTOCode]+ ", "+ strKL[0]);}
                else if(strState.toUpperCase().contains("LD")){tempString=(strLD[intRTOCode]+ ", "+ strLD[0]);}
                else if(strState.toUpperCase().contains("MH")){tempString=(strMH[intRTOCode]+ ", "+ strMH[0]);}
                else if(strState.toUpperCase().contains("ML")){tempString=(strML[intRTOCode]+ ", "+ strML[0]);}
                else if(strState.toUpperCase().contains("MN")){tempString=(strMN[intRTOCode]+ ", "+ strMN[0]);}
                else if(strState.toUpperCase().contains("MP")){tempString=(strMP[intRTOCode]+ ", "+ strMP[0]);}
                else if(strState.toUpperCase().contains("MZ")){tempString=(strMZ[intRTOCode]+ ", "+ strMZ[0]);}
                else if(strState.toUpperCase().contains("NL")){tempString=(strNL[intRTOCode]+ ", "+ strNL[0]);}
                else if(strState.toUpperCase().contains("OR")){tempString=(strOR[intRTOCode]+ ", "+ strOR[0]);}
                else if(strState.toUpperCase().contains("PB")){tempString=(strPB[intRTOCode]+ ", "+ strPB[0]);}
                else if(strState.toUpperCase().contains("PY")){tempString=(strPY[intRTOCode]+ ", "+ strPY[0]);}
                else if(strState.toUpperCase().contains("RJ")){tempString=(strRJ[intRTOCode]+ ", "+ strRJ[0]);}
                else if(strState.toUpperCase().contains("SK")){tempString=(strSK[intRTOCode]+ ", "+ strSK[0]);}
                else if(strState.toUpperCase().contains("TN")){tempString=(strTN[intRTOCode]+ ", "+ strTN[0]);}
                else if(strState.toUpperCase().contains("TR")){tempString=(strTR[intRTOCode]+ ", "+ strTR[0]);}
                else if(strState.toUpperCase().contains("UK")){tempString=(strUK[intRTOCode]+ ", "+ strUK[0]);}
                else if(strState.toUpperCase().contains("UP")){tempString=(strUP[intRTOCode]+ ", "+ strUP[0]);}
                else if(strState.toUpperCase().contains("WB")){tempString=(strWB[intRTOCode]+ ", "+ strWB[0]);}
                else{
                    Log.v("GGGGGGGGGGGGGGGGGG","...");
                    for(int i=1;i<strAN.length;i++){if(strAN[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strAN[0]+i+"-"+strAN[i];}}
                    for(int i=1;i<strAP.length;i++){if(strAP[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strAP[0]+i+"-"+strAP[i];}}
                    for(int i=1;i<strAR.length;i++){if(strAR[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strAR[0]+i+"-"+strAR[i];}}
                    for(int i=1;i<strAS.length;i++){if(strAS[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strAS[0]+i+"-"+strAS[i];}}
                    for(int i=1;i<strBR.length;i++){if(strBR[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strBR[0]+i+"-"+strBR[i];}}
                    for(int i=1;i<strCG.length;i++){if(strCG[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strCG[0]+i+"-"+strCG[i];}}
                    for(int i=1;i<strCH.length;i++){if(strCH[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strCH[0]+i+"-"+strCH[i];}}
                    for(int i=1;i<strDD.length;i++){if(strDD[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strDD[0]+i+"-"+strDD[i];}}
                    for(int i=1;i<strDL.length;i++){if(strDL[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strDL[0]+i+"-"+strDL[i];}}
                    for(int i=1;i<strDN.length;i++){if(strDN[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strDN[0]+i+"-"+strDN[i];}}
                    for(int i=1;i<strGA.length;i++){if(strGA[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strGA[0]+i+"-"+strGA[i];}}
                    for(int i=1;i<strGJ.length;i++){if(strGJ[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strGJ[0]+i+"-"+strGJ[i];}}
                    for(int i=1;i<strHP.length;i++){if(strHP[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strHP[0]+i+"-"+strHP[i];}}
                    for(int i=1;i<strHR.length;i++){if(strHR[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strHR[0]+i+"-"+strHR[i];}}
                    for(int i=1;i<strJH.length;i++){if(strJH[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strJH[0]+i+"-"+strJH[i];}}
                    for(int i=1;i<strJK.length;i++){if(strJK[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strJK[0]+i+"-"+strJK[i];}}
                    for(int i=1;i<strKA.length;i++){if(strKA[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strKA[0]+i+"-"+strKA[i];}}
                    for(int i=1;i<strKL.length;i++){if(strKL[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strKL[0]+i+"-"+strKL[i];}}
                    for(int i=1;i<strLD.length;i++){if(strLD[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strLD[0]+i+"-"+strLD[i];}}
                    for(int i=1;i<strMH.length;i++){if(strMH[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strMH[0]+i+"-"+strMH[i];}}
                    for(int i=1;i<strML.length;i++){if(strML[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strML[0]+i+"-"+strML[i];}}
                    for(int i=1;i<strMN.length;i++){if(strMN[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strMN[0]+i+"-"+strMN[i];}}
                    for(int i=1;i<strMP.length;i++){if(strMP[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strMP[0]+i+"-"+strMP[i];}}
                    for(int i=1;i<strMZ.length;i++){if(strMZ[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strMZ[0]+i+"-"+strMZ[i];}}
                    for(int i=1;i<strNL.length;i++){if(strNL[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strNL[0]+i+"-"+strNL[i];}}
                    for(int i=1;i<strOR.length;i++){if(strOR[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strOR[0]+i+"-"+strOR[i];}}
                    for(int i=1;i<strPB.length;i++){if(strPB[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strPB[0]+i+"-"+strPB[i];}}
                    for(int i=1;i<strPY.length;i++){if(strPY[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strPY[0]+i+"-"+strPY[i];}}
                    for(int i=1;i<strRJ.length;i++){if(strRJ[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strRJ[0]+i+"-"+strRJ[i];}}
                    for(int i=1;i<strSK.length;i++){if(strSK[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strSK[0]+i+"-"+strSK[i];}}
                    for(int i=1;i<strTN.length;i++){if(strTN[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strTN[0]+i+"-"+strTN[i];}}
                    for(int i=1;i<strTR.length;i++){if(strTR[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strTR[0]+i+"-"+strTR[i];}}
                    for(int i=1;i<strUK.length;i++){if(strUK[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strUK[0]+i+"-"+strUK[i];}}
                    for(int i=1;i<strUP.length;i++){if(strUP[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strUP[0]+i+"-"+strUP[i];}}
                    for(int i=1;i<strWB.length;i++){if(strWB[i].toUpperCase().contains(strState.toUpperCase())){tempString=tempString+", "+strWB[0]+i+"-"+strWB[i];}}
...
//		datasource.close();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent i = new Intent(RTOActivity.this, TrainActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_gallery) {
            Intent i = new Intent(RTOActivity.this, ChecklistActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(RTOActivity.this, checktask.class);
            startActivity(i);

        } else if (id == R.id.nav_add_train) {
            Intent i = new Intent(RTOActivity.this, MVCView.class);
            startActivity(i);
        } else if (id == R.id.nav_add_station) {
            Intent i = new Intent(RTOActivity.this, AddStation.class);
            startActivity(i);
