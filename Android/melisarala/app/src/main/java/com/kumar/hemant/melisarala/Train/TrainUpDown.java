...
public class TrainUpDown extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void prepareTrainData() {
        ...
        ///////////////////////////
            ...
            String arrivalTime = ""+traintimes.size()+":" +traintimes.get(0).toString();
        ...
        for(int i=0;i<traintimes.size();i++) {
            if(stationName!=null){
                ...
                tvDownMiddleHeading.setText("Dehuroad: "+stationName);
                tvUpMiddleHeading.setText("Dehuroad");
            }

            if(stationName.contains("Dehuroad"))
            {
                String[] abcd = traintimes.get(i).split("-");
                train = new Train(abcd[0],abcd[1],abcd[2],abcd[3],abcd[4],abcd[5]);
                trainList.add(train);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_select_station) {
            Intent i = new Intent(TrainUpDown.this, SearchStationActivity.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_add_train) {
            Intent i = new Intent(TrainUpDown.this, AddTrain.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_add_station) {
            Intent i = new Intent(TrainUpDown.this, AddStation.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_add_train_station) {
            Intent i = new Intent(TrainUpDown.this, AddTrainStation.class);
            startActivity(i);
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent i = new Intent(TrainUpDown.this, TrainUpDown.class);
            startActivity(i);
        } else if (id == R.id.nav_gallery) {
            Intent i = new Intent(TrainUpDown.this, ChecklistActivity.class);
            startActivity(i);

        } else if (id == R.id.nav_slideshow) {
            Intent i = new Intent(TrainUpDown.this, RTOActivity.class);
            startActivity(i);

        } else if (id == R.id.nav_manage) {
            Intent i = new Intent(TrainUpDown.this, checktask.class);
            startActivity(i);
            ...
            Intent i = new Intent(TrainUpDown.this, MVCView.class);
            startActivity(i);
