...
public class TrainActivityMVC extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_train_mvc);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_train_mvc);
        ...
        tvDownMiddleHeading = (TextView) findViewById(R.id.downMiddleHeadingMVC);
        tvDownMiddleHeading.setText(stationName);
        tvUpMiddleHeading = (TextView) findViewById(R.id.upMiddleHeadingMVC);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent i = new Intent(TrainActivityMVC.this, TrainActivityMVC.class);
            startActivity(i);
        } else if (id == R.id.nav_gallery) {
            Intent i = new Intent(TrainActivityMVC.this, ChecklistActivity.class);
            startActivity(i);

        } else if (id == R.id.nav_slideshow) {
            Intent i = new Intent(TrainActivityMVC.this, RTOActivity.class);
            startActivity(i);

        } else if (id == R.id.nav_manage) {
            Intent i = new Intent(TrainActivityMVC.this, checktask.class);
            startActivity(i);

        } else if (id == R.id.nav_share) {
            Intent i = new Intent(TrainActivityMVC.this, SearchStationActivity.class);
            startActivity(i);

        } else if (id == R.id.nav_camera) {
            Intent i = new Intent(TrainActivityMVC.this, TrainActivity.class);
            startActivity(i);
